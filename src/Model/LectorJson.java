...
public class LectorJson {
    ...
    public static void Json(String[] args) {             //Els args son useless
        Configuracio data = new Configuracio();          // Dades a carregar
        Gson        gson = new Gson();                   // Entitat Gson
        JsonReader  reader;                              // Reader de JSON
    ...
    public static ConfiguracioServer carregaConfiguracio() {
        ConfiguracioServer data = new ConfiguracioServer();          // Dades a carregar
        Gson        gson = new Gson();                   // Entitat Gson
        JsonReader  reader;                              // Reader de JSON
